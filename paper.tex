...
and
$\Of{\varsigma_{\Upsilon\parallel\Gamma}}{P_\tau^{\Yoneda{\Upsilon\parallel\Gamma}}
  ...
  \ADefine{\psi}{
   \begin{tikzcd}[ampersand replacement = \&, sep=28ex]
     {\SemBrackets{\Omega\triangleright\Upsilon\parallel\Gamma}_P}
        \arrow[r, "\Tuple{\SemBrackets{\Omega\triangleright\Upsilon\parallel\Gamma\vdash M:q}_P}_{(M,q)\in \vec{M}\otimes\vec{\tau}}"]
     \& {P^{[\vec{\tau}]}}
   \end{tikzcd}
  }
\end{align*}
