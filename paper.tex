...
$X$, it is precisely the sheaf condition for covariant presheafs on $\SCtx$
under the atomic topology \cite[p.~126]{mac-lane-moerdijk:1992}. The sheaf condition, then, ensures that the notion
...
$\mathtt{get}[v]$. Because the category $\Discrete{\Arities}$ is discrete and
has only identity arrows, through an abuse of notation we will often write
$\vartheta\varrho$ to mean $\FLift{\varrho}{\ArrId{}}(\vartheta)$.
