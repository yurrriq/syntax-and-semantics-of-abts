...
construction\footnote{Category of elements.} $\Grothendieck{}{}$ on the operator
presheaf $\Operators$ we also have a category with objects
...
$\Member{\Restriction{f}\vartheta =
  \vartheta'}{\Operators\Pair{\Upsilon'}{\varrho'}}$.
