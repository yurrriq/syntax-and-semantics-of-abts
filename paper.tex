...
\IMode{{\pi_{{\Operators}_{\lambda}}}^{-1}}&=\IMode{\bigcup_{\Pair{\Upsilon}{a}}{{\pi_{{\Operators}_{\lambda}}}^{-1}{\Pair{\Upsilon}{a}}}}\quad&&=
...
\begin{remark}
  ...
  extension operation $\Of{{(\,-\,)}^{\circledast}}{{\IMode{{P(\,=\,)}^{V(\,-\,)}}}\to{\IMode{{P(\,=\,)}^{P(\,-\,)}}}}$.
\end{remark}
...
\[
  \begin{tikzcd}[cramped, ampersand replacement = \&]
    ...
    \&[4.0em] {\IMode{P_{\tau}^{\Yoneda{\vec{\sigma}\parallel\vec{\tau}}}\times S^{\{\vec{\sigma}\}} \times P^{[\vec{\tau}]}}}
...
\[
  \begin{tikzcd}[cramped, ampersand replacement = \&]
    ...
    \&[4.0em] {\IMode{\SemBrackets{\Omega\triangleright\Upsilon,\vec{\sigma}_i\parallel\Gamma,\vec{\tau}_i}_P}}
