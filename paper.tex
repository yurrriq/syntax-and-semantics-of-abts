...
\CatchFileBetweenTags\tmp{Code.tex}{agda}

\subsection{Kan Extensions}

\subsubsection{Lan}

\ExecuteMetaData[Code.tex]{lang}\\

\ExecuteMetaData[Code.tex]{lan}

\subsubsection{Ran}

\ExecuteMetaData[Code.tex]{rang}\\

\ExecuteMetaData[Code.tex]{ran}

\subsection{Variables and Symbols}

\ExecuteMetaData[Code.tex]{var}\\

\ExecuteMetaData[Code.tex]{sym}

\subsection{Contexts}

\ExecuteMetaData[Code.tex]{ctx}\\

\ExecuteMetaData[Code.tex]{sctx}\\

\ExecuteMetaData[Code.tex]{ctxdom}\\

\ExecuteMetaData[Code.tex]{ctxidx}\\

\ExecuteMetaData[Code.tex]{elem}

\subsection{Signatures}

\ExecuteMetaData[Code.tex]{sign}

\subsection{Trees}

\ExecuteMetaData[Code.tex]{trees}

\subsection{Substitution Monoidal Structure}

\ExecuteMetaData[Code.tex]{H}\\

\ExecuteMetaData[Code.tex]{HHat}\\

\ExecuteMetaData[Code.tex]{V}\\

\ExecuteMetaData[Code.tex]{tensor0}\\

\ExecuteMetaData[Code.tex]{tensor1}\\

\ExecuteMetaData[Code.tex]{extension}
