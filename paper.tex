...
likewise, $S^{\{\Upsilon\}}$ shall mean
$\prod_{u\in\Dom\Upsilon}S_{\Upsilon(u)}$.
...
\ExecuteMetaData[latex/Code.tex]{S}\\
...
\subsection{Signature Endofunctor}

\ExecuteMetaData[latex/Code.tex]{endofunctor}

\subsection{Interpretation}

\ExecuteMetaData[latex/Code.tex]{interpretation}
