...
in $\SCtx$ lift to renamings of operators' parameters. Then by the Grothendieck
construction $\Iso{\Grothendieck{}{\Operators}}{\Comma{𝟙}{\Operators}}$
we have a category of elements of $\Operators$ where objects are triples
