...
\newcommand\IsOperator[3]{\IMode{#1}\,{\Vdash}_{\scriptscriptstyle{\Operators}}\,\IMode{#2}: \OMode{#3}}
...
\newcommand\IsAbt[5]{%
  ...
  \IMode{#2}\parallel%
  \,{\IMode{#3}\vdash}_{\scriptscriptstyle{\Operators}}\,%
  \IMode{#4}:\OMode{#5}%
}
\newcommand\IsWf[5]{%
  \IMode{#1}\triangleright%
...
in $\SCtx$ lift to renamings of operators' parameters. By the Grothendieck
construction $\Iso{\Grothendieck{}{\Operators}}{\Comma{*}{\Operators}}$ we have
a category of elements of $\Operators$ where objects are triples
...
\begin{alignat*}{3}
  &{\pi_{\Operators}}^{-1}{\Pair{\Upsilon}{a}}&&\,\mathrel{\ {{:}}}\,&&\Sets\\
  &{\pi_{\Operators}}^{-1}{\Pair{\Upsilon}{a}}&&\,=\,\ && %
    \{\,\vartheta \in \Pair{\Upsilon}{a}%
      {{|}}\ {\pi_{\Operators}}{\Pair{\Pair{\Upsilon}{a}}{\vartheta}} = \Pair{\Upsilon}{a}%
  \}
\end{alignat*}
...
give its signature by asserting the following about its operators:
\begin{gather*}
...
\end{gather*}
These rules correspond to objects of $\Grothendieck{}{\Operators}$ and we
collect their fibers into sets of operators:
\begin{alignat*}{5}
{\pi_{\Operators}}^{-1}&\Pair{\Upsilon}{{\MkArity{\MkValence{}{\SortExp}{\SortExp}}{\SortExp}}}\quad&&=
  &&\quad\{\,\lambda\,\}\\
{\pi_{\Operators}}^{-1}&\Pair{\Upsilon}{\MkArity{\MkValence{}{}{\SortExp},\MkValence{}{}{\SortExp}}{\SortExp}}\quad&&=
  &&\quad\{\,\mathtt{ap}\,\}\\
\bigcup_{\Pair{\Upsilon}{a}}&{{\pi_{\Operators}}^{-1}{\Pair{\Upsilon}{a}}}\quad&&=
  &&\quad\{\,\lambda,\ \mathtt{ap}\,\}\\
\end{alignat*}
