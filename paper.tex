...
to renamings of operators' parameters. Via the Grothendieck
construction\footnote{Category of elements.} $\Grothendieck{}{}$ on the
operator presheaf $\Operators$ we also have a category with objects
...
$\Member{\vartheta}{f^{*}\Operators}\Pair{\Upsilon'}{\varrho'} = \vartheta'$.
