...
$\Omega$, parameters in $\Upsilon$, and variables in $\Gamma$. Then, the syntax
of abstract binding trees is inductively defined in three rules:
...
\begin{gather*}
  ...
  \infer[\textit{app}]{
    \IsAbt{\Omega}{\Upsilon}{\Gamma}{
      \App{\vartheta}{M_0,\dots,M_n}
    }{s}
  }{
    \begin{array}{l}
      \IsOperator{\Dom{\Upsilon}}{\vartheta}{
        \MkArity{v_0,\dots,v_n}{s}
      }\\
      \HypJ{
        \IsAbt{\Omega}{\Upsilon}{\Gamma}{M_i}{q_i}
      }{
