...
\newcommand\AtomicCoverage{J_{\mathtt{atm}}}

\DeclareMathOperator{\Perm}{\mathbf{Perm}}

\newcommand\RuleNameVar[2]{{#1}_{\textit{var}_{#2}}}
\newcommand\RuleNameMVar[2]{{#1}_{\textit{mvar}_{#2}}}
\newcommand\RuleNameApp[1]{{#1}_\textit{app}}
\newcommand\RuleNameAbs[2]{{#1}_{\textit{abs}_{#2}}}
...
\begin{definition}[Sieves and matching families]
...
\begin{definition}[Sites and coverages]
...
\begin{definition}[Separation and sheafhood]
...
\begin{definition}[The atomic topology]
...
\newcommand\RuleIsAbtVar{\RuleNameVar{\vdash}{}}
\newcommand\RuleIsAbtMVar{\RuleNameMVar{\vdash}{}}
\newcommand\RuleIsAbtApp{\RuleNameApp{\vdash}}
\newcommand\RuleIsAbtAbs{\RuleNameAbs{\vdash}{}}
...
The rules for metavariable substitution are reminiscent of the ``hereditary
