...
along the the codomain Grothendieck bifibration $\pi_{cod}$ where
...
\begin{tikzcd}[ampersand replacement = \&, sep = large]
  {\Grothendieck{}{\Operators}}
    \arrow[rr, "{\Pair{\Pair{\Upsilon}{a}}{\vartheta}\ \mapsto\ \ArrId{\Operators\Pair{\Upsilon}{a}}}"]
    \arrow[d, "{\pi_{\Operators}}" left]
  \&
  \& {\Arr{\Sets}}
    \arrow[d, "{\pi_{cod}}"] \\
  {\SCtx\times\Discrete{\Arities}}
     \arrow[rr, "{\Operators}" below]
  \&
  \& {\Sets} \\
\end{tikzcd}
\]
