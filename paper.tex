...
$\Discrete{\Arities}$ is discrete and has only identity arrows, through an
abuse of notation we will often write $\Restriction{\varrho}$ to mean
$\Restriction{\Pair{\varrho}{\ArrId}}$. In particular, the renaming
