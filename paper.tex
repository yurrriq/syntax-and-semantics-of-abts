...
under the atomic topology \cite[p.~126]{mac-lane-moerdijk:1992}.
%%% TODO: add definition of atomic coverage
The sheaf condition, then, ensures that the notion of support is well-behaved in the
following sense: if some term lies in two different fibers, then it may be
\emph{strengthened} uniquely into the fibre of its support.
